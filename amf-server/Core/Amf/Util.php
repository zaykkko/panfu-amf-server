...
class Amfphp_Core_Amf_Util {
     ...
     * @return <Boolean>
     */
    static function isSystemBigEndian() {
     ...
     */
    static function applyFunctionToContainedObjects($obj, $callBack, $recursionDepth = 0, $maxRecursionDepth = 30, $ignoreAmfTypes = true) {

...
class AmfphpFlexMessaging {
     ...
     * @return array
     */
    function filterAmfRequestMessageHandler($handler, Amfphp_Core_Amf_Message $requestMessage) {
     ...
     * @return array
     */
    function filterAmfExceptionHandler($handler) {
     ...
     */
    function generateErrorResponse(Exception $exception) {
